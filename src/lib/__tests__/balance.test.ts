...
function mkMiembro(id: string): Miembro {
  return { id, sala_id: 's1', nombre: id, color: '#000', gradiente: null, icono: null, user_id: null, whatsapp_phone: null, foto_url: null, bio: null, rol_casa: null, cumpleanos: null, metodo_pago: null, creado_en: '2024-01-01' }
}
